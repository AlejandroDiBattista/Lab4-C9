...
learning_rate = st.sidebar.number_input("Tasa de aprendizaje", min_value=0.0, max_value=1.0, value=0.1, step=0.01)
num_epochs = st.sidebar.number_input("Cantidad de épocas", min_value=10, max_value=10000, value=100, step=10)
hidden_size = st.sidebar.number_input("Neuronas en la capa oculta", min_value=1, max_value=100, value=5, step=1)
...
if st.sidebar.button("Entrenar"):
    ...
    fig, ax = plt.subplots()
    ax.plot(perdida_historial, label="Pérdida")
    ax.set_xlabel("Época")
